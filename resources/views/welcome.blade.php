...
<head>
  ...
  <title>Tasty Bites - Super delicious Burger in town!</title>
  ...
  <link rel="preload" as="image" href="{{ asset('frontend/assets/images/hero-banner.png') }}" media="min-width(768px)">
  <link rel="preload" as="image" href="{{ asset('frontend/assets/images/hero-banner-bg.png') }}" media="min-width(768px)">
  <link rel="preload" as="image" href="{{ asset('frontend/assets/images/hero-bg.jpg') }}">
...
<body id="top">
  ...
  <header class="header" data-header>
    <div class="container">
      ...
      <h1>
        <a href="#" class="logo">Tasty Bites<span class="span">.</span></a>
      </h1>
      ...
      <section class="hero" id="home" style="background-image: url('{{ asset('frontend/assets/images/hero-bg.jpg') }}')">
        <div class="container">
          ...
          <figure class="hero-banner">
            <img src="{{ asset('frontend/assets/images/hero-banner-bg.png') }}" width="820" height="716" alt="" aria-hidden="true"
              class="w-100 hero-img-bg">

            <img src="{{ asset('frontend/assets/images/hero-banner.png') }}" width="700" height="637" loading="lazy" alt="Burger"
          ...
          <ul class="promo-list has-scrollbar">
            ...
            <li class="promo-item">
              <div class="promo-card">
                ...
                <img src="{{ asset('frontend/assets/images/promo-1.png') }}" width="300" height="300" loading="lazy" alt="Maxican Pizza"
            ...
            <li class="promo-item">
              <div class="promo-card">
                ...
                <img src="{{ asset('frontend/assets/images/promo-2.png') }}" width="300" height="300" loading="lazy" alt="Soft Drinks"
                  class="w-100 card-banner">
            ...
            <li class="promo-item">
              <div class="promo-card">
                ...
                <img src="{{ asset('frontend/assets/images/promo-3.png') }}" width="300" height="300" loading="lazy" alt="French Fry"
                  class="w-100 card-banner">
            ...
            <li class="promo-item">
              <div class="promo-card">
                ...
                <img src="{{ asset('frontend/assets/images/promo-4.png') }}" width="300" height="300" loading="lazy" alt="Burger Kingo"
                  class="w-100 card-banner">
            ...
            <li class="promo-item">
              <div class="promo-card">
                ...
                <img src="{{ asset('frontend/assets/images/promo-5.png') }}" width="300" height="300" loading="lazy" alt="Chicken Masala"
                  class="w-100 card-banner">
      ...
      <section class="section section-divider gray about" id="about">
        <div class="container">
          ...
          <div class="about-banner">
            <img src="{{ asset('frontend/assets/images/about-banner.png') }}" width="509" height="459" loading="lazy" alt="Burger with Drinks"
              class="w-100 about-img">

            <img src="{{ asset('frontend/assets/images/sale-shape-red.png') }}" width="216" height="226" alt="get up to 50% off now"
          ...
          <ul class="food-menu-list">
            ...
            <li>
              <div class="food-menu-card">
                ...
                <div class="card-banner">
                  <img src="{{ asset('frontend/assets/images/food-menu-1.png') }}" width="300" height="300" loading="lazy"
                ...
                <div class="price-wrapper">
                  ...
                  <data class="price">Rs. 490.00</data>

                  <del class="del" value="69.00">Rs. 690.00</del>
            ...
            <li>
              <div class="food-menu-card">
                ...
                <div class="card-banner">
                  <img src="{{ asset('frontend/assets/images/food-menu-2.png') }}" width="300" height="300" loading="lazy"
                ...
                <div class="price-wrapper">
                  ...
                  <data class="price" value="29.00">Rs. 290.00</data>

                  <del class="del">Rs. 390.00</del>
            ...
            <li>
              <div class="food-menu-card">
                ...
                <div class="card-banner">
                  <img src="{{ asset('frontend/assets/images/food-menu-3.png') }}" width="300" height="300" loading="lazy"
                ...
                <div class="price-wrapper">
                  ...
                  <data class="price" value="49.00">Rs. 490.00</data>

                  <del class="del">Rs. 670.00</del>
            ...
            <li>
              <div class="food-menu-card">
                ...
                <div class="card-banner">
                  <img src="{{ asset('frontend/assets/images/food-menu-4.png') }}" width="300" height="300" loading="lazy"
                ...
                <div class="price-wrapper">
                  ...
                  <data class="price" value="59.00 ">Rs. 590.00</data>

                  <del class="del">Rs. 690.00</del>
            ...
            <li>
              <div class="food-menu-card">
                ...
                <div class="card-banner">
                  <img src="{{ asset('frontend/assets/images/food-menu-5.png') }}" width="300" height="300" loading="lazy"
            ...
            <li>
              <div class="food-menu-card">
                ...
                <div class="card-banner">
                  <img src="{{ asset('frontend/assets/images/food-menu-6.png') }}" width="300" height="300" loading="lazy"
      ...
      <section class="section section-divider white cta" style="background-image: url('{{ asset('frontend/assets/images/hero-bg.jpg') }}')">
        <div class="container">
          ...
          <figure class="cta-banner">
            <img src="{{ asset('frontend/assets/images/cta-banner.png') }}" width="700" height="637" loading="lazy" alt="Burger"
              class="w-100 cta-img">

            <img src="{{ asset('frontend/assets/images/sale-shape.png') }}" width="216" height="226" loading="lazy"
      ...
      <section class="section section-divider gray delivery">
        <div class="container">
          ...
          <figure class="delivery-banner">
            <img src="{{ asset('frontend/assets/images/delivery-banner-bg.png') }}" width="700" height="602" loading="lazy" alt="clouds"
              class="w-100">

            <img src="{{ asset('frontend/assets/images/delivery-boy.svg') }}" width="1000" height="880" loading="lazy" alt="delivery boy"
            ...
            <li class="testi-item">
              <div class="testi-card">
                ...
                <div class="profile-wrapper">
                  ...
                  <figure class="avatar">
                    <img src="{{ asset('frontend/assets/images/avatar-1.jpg') }}" width="80" height="80" loading="lazy" alt="Robert William">
                  </figure>

                  <div>
                    <h3 class="h4 testi-name">USMAN ABBAS</h3>
            ...
            <li class="testi-item">
              <div class="testi-card">
                ...
                <div class="profile-wrapper">
                  ...
                  <figure class="avatar">
                    <img src="{{ asset('frontend/assets/images/avatar-2.jpg') }}" width="80" height="80" loading="lazy" alt="Thomas Josef">
                  </figure>

                  <div>
                    <h3 class="h4 testi-name">ALI AHMAD</h3>
            ...
            <li class="testi-item">
              <div class="testi-card">
                ...
                <div class="profile-wrapper">
                  ...
                  <figure class="avatar">
                    <img src="{{ asset('frontend/assets/images/avatar-3.jpg') }}" width="80" height="80" loading="lazy" alt="Charles Richard">
                  </figure>

                  <div>
                    <h3 class="h4 testi-name">ZAIN JAVED</h3>
          ...
          <ul class="banner-list">
            ...
            <li class="banner-item banner-lg">
              <div class="banner-card">
                ...
                <img src="{{ asset('frontend/assets/images/banner-1.jpg') }}" width="550" height="450" loading="lazy"
            ...
            <li class="banner-item banner-sm">
              <div class="banner-card">
                ...
                <img src="{{ asset('frontend/assets/images/banner-2.jpg') }}" width="550" height="465" loading="lazy" alt="Delicious Pizza"
                  class="banner-img">
            ...
            <li class="banner-item banner-sm">
              <div class="banner-card">
                ...
                <img src="{{ asset('frontend/assets/images/banner-3.jpg') }}" width="550" height="465" loading="lazy" alt="American Burgers"
                  class="banner-img">

                <div class="banner-item-content">
                  <h3 class="banner-title">Special Burgers</h3>
            ...
            <li class="banner-item banner-md">
              <div class="banner-card">
                ...
                <img src="{{ asset('frontend/assets/images/banner-4.jpg') }}" width="550" height="220" loading="lazy" alt="Tasty Buzzed Pizza"
                  class="banner-img">
          ...
          <ul class="blog-list">
            ...
            <li>
              <div class="blog-card">
                ...
                <div class="card-banner">
                  <img src="{{ asset('frontend/assets/images/blog-1.jpg') }}" width="600" height="390" loading="lazy"
                ...
                <div class="card-content">
                  ...
                  <div class="card-meta-wrapper">
                    ...
                    <a href="#" class="card-meta-link">
                      ...
                      <time class="meta-info" datetime="2022-01-01">Jan 01 2026</time>
                    </a>
            ...
            <li>
              <div class="blog-card">
                ...
                <div class="card-banner">
                  <img src="{{ asset('frontend/assets/images/blog-2.jpg') }}" width="600" height="390" loading="lazy"
            ...
            <li>
              <div class="blog-card">
                ...
                <div class="card-banner">
                  <img src="{{ asset('frontend/assets/images/blog-3.jpg') }}" width="600" height="390" loading="lazy"
    ...
    <div class="footer-top" style="background-image: url('{{ asset('frontend/assets/images/footer-illustration.png') }}')">
      <div class="container">
        ...
        <ul class="footer-list">
          ...
          <li>
            <p class="footer-list-item">+92 (062) 109-9222</p>
          </li>

          <li>
            <p class="footer-list-item">Info.tastybites11@gmail.com</p>
          </li>
        ...
        <ul class="footer-list">
          ...
          <li>
            <p class="footer-list-item">Monday-Friday: 01:00pm-12:00am</p>
          </li>
          ...
          <li>
            <p class="footer-list-item">Saturday: 10:00pm-12:00am</p>
          </li>
    ...
    <div class="footer-bottom">
      <div class="container">
        <p class="copyright-text">
          &copy; 2026 <a href="#" class="copyright-link">code_with_ramsha</a> All Rights Reserved.
        </p>
      </div>
    </div>
