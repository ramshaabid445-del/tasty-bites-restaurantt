                        ...
                        <form action="{{ route('admin.menu-items.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="name" class="form-control" value="{{ old('name') }}" placeholder="e.g., Zinger Burger" required>
                                </div>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <textarea name="description" class="form-control" rows="3" placeholder="Ingredients or details about the dish...">{{ old('description') }}</textarea>
                                </div>

                                <div class="col-md-12">
                                    <label class="form-label fw-bold">Item Image</label>
                                    <input type="file" name="image" class="form-control" accept="image/*">
                                    <small class="text-muted mt-1 d-block">Recommended size: 600x400px</small>
                                </div>
                            </div>
