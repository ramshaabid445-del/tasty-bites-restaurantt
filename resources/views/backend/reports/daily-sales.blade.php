...
<div class="pc-container" style="padding-top: 80px; background: #f8f9fa;">
    <div class="pc-content">
        <div class="row align-items-center mb-4">
            ...
            <div class="col-md-6 text-md-end">
                <form action="" method="GET" class="d-inline-block">
                    <input type="date" name="date" value="{{ $date->format('Y-m-d') }}" class="form-control d-inline-block w-auto border-0 shadow-sm" onchange="this.form.submit()">
                </form>
        ...
        <div class="row g-4 mb-4">
            ...
            <div class="col-md-3">
                <div class="card border-0 shadow-sm bg-white p-3" style="border-radius: 15px;">
