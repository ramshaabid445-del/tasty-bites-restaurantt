...
<head>
  ...
  <meta name="author" content="M. Irfan Bashir">

  <link rel="icon" href="{{ asset('backend/assets/images/favicon.svg') }}" type="image/x-icon">
  <link href="{{ asset('backend/assets/css/plugins/animate.min.css') }}" rel="stylesheet" type="text/css">
  ...
  <link rel="stylesheet" href="{{ asset('backend/assets/css/landing.css') }}">
</head>
    ...
    <nav class="navbar navbar-expand-md navbar-dark top-nav-collapse default">
      <div class="container">
        <a class="navbar-brand" href="#">
          <img src="{{ asset('backend/assets/images/logo-white.svg') }}" alt="logo">
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
          <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
            ...
            <li class="nav-item">
              <a class="btn btn-primary" target="_blank" href="#">Purchase Now</a>
            </li>
          </ul>
        </div>
      </div>
      ...
      <div class="row align-items-center justify-content-center text-center">
        <div class="col-md-9 col-xl-6">
          ...
          <div class="my-5 wow fadeInUp" data-wow-delay="0.6s">
            <a href="#" class="btn btn-outline-primary me-2" target="_blank">Explore Components</a>
